  ...
  void insertToWormhole() throws Throwable {
    execute(
        new TestCase<List<Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Insert to Wormhole (Wormhole4j)";
          }
  ...
  void insertToRedBlackTreeMap() throws Throwable {
    execute(
        new TestCase<List<Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Insert to Red-Black tree (TreeMap)";
          }
  ...
  void insertToAVLTreeMap() throws Throwable {
    execute(
        new TestCase<List<Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Insert to AVL tree map (Fastutil)";
          }
  ...
  void getFromWormhole() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<WormholeForLongKey<Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Get from Wormhole (Wormhole4j)";
          }
  ...
  void getFromRedBlackTreeMap() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<TreeMap<Long, Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Get from Red-Black tree (TreeMap)";
          }
  ...
  void getFromAVLTreeMap() throws Throwable {
    execute(
        new TestCase<
          ...
          @Override
          public String label() {
            return "[Long key] Get from AVL tree map (Fastutil)";
          }
  ...
  void updateWormhole() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<WormholeForLongKey<Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Update Wormhole (Wormhole4j)";
          }
  ...
  void updateRedBlackTreeMap() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<TreeMap<Long, Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Update Red-Black tree (TreeMap)";
          }
  ...
  void updateAVLTreeMap() throws Throwable {
    execute(
        new TestCase<
          ...
          @Override
          public String label() {
            return "[Long key] Update AVL tree map (Fastutil)";
          }
  ...
  void deleteFromWormhole() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<WormholeForLongKey<Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Delete from Wormhole (Wormhole4j)";
          }
  ...
  void deleteFromRedBlackTreeMap() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<TreeMap<Long, Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Delete from Red-Black tree (TreeMap)";
          }
  ...
  void deleteFromAVLTreeMap() throws Throwable {
    execute(
        new TestCase<
          ...
          @Override
          public String label() {
            return "[Long key] Delete from AVL tree map (Fastutil)";
          }
  ...
  void scanFromWormhole() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<WormholeForLongKey<Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Scan from Wormhole (Wormhole4j)";
          }
  ...
  void scanFromRedBlackTreeMap() throws Throwable {
    execute(
        new TestCase<ResourceAndKeys<TreeMap<Long, Integer>, Long>, RuntimeException>() {
          @Override
          public String label() {
            return "[Long key] Scan from Red-Black tree (TreeMap)";
          }
  ...
  void scanFromAVLTreeMap() throws Throwable {
    execute(
        new TestCase<
          ...
          @Override
          public String label() {
            return "[Long key] Scan from AVL tree map (Fastutil)";
          }
