...
public class MultiThreadBenchmarkConcurrentWormholeForIntKey {
  ...
  public void putAndGetBenchmarkPut(
      IntKeysState keysState,
      MultiThreadBenchmarkConcurrentSkipListMapForIntKey.FullState fullState) {
