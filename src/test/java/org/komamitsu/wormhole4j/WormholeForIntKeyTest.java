...
class WormholeForIntKeyTest {
  ...
  class Scan extends Common {
    ...
    void withOneLeafNodeWithOneRecord_ShouldReturnIt() {
      ...
      // Act & Assert
      KeyValue<Integer, ByteArrayEncodedKey, Integer> firstItem =
          new KeyValue<>(createForTest(wormhole, 10), 100);
    ...
    void withOneLeafNodeWithMaxRecords_ShouldReturnIt() {
      ...
      KeyValue<Integer, ByteArrayEncodedKey, Integer> firstItem =
          new KeyValue<>(createForTest(wormhole, 10), 100);
      KeyValue<Integer, ByteArrayEncodedKey, Integer> secondItem =
          new KeyValue<>(createForTest(wormhole, 20), 200);
      KeyValue<Integer, ByteArrayEncodedKey, Integer> thirdItem =
          new KeyValue<>(createForTest(wormhole, 30), 300);
      assertThat(wormhole.scanWithCount(9, 1)).containsExactly(firstItem);
    ...
    void withTwoLeafNodes_ShouldReturnIt() {
      ...
      KeyValue<Integer, ByteArrayEncodedKey, Integer> thirdItem =
          new KeyValue<>(createForTest(wormhole, 30), 300);
      KeyValue<Integer, ByteArrayEncodedKey, Integer> fourthItem =
          new KeyValue<>(createForTest(wormhole, 40), 400);
      KeyValue<Integer, ByteArrayEncodedKey, Integer> fifthItem =
          new KeyValue<>(createForTest(wormhole, 50), 500);
      assertThat(wormhole.scanWithCount(9, 1)).containsExactly(firstItem);
      assertThat(wormhole.scanWithCount(9, 2)).containsExactly(firstItem, secondItem);
      assertThat(wormhole.scanWithCount(9, 3)).containsExactly(firstItem, secondItem, thirdItem);
  ...
  private <V> Key<Integer, ByteArrayEncodedKey> createForTest(
      WormholeForIntKey<V> wormhole, Integer key) {
