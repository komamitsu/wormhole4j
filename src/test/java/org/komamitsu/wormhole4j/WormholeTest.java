...
class WormholeTest {
  ...
  class Scan extends Common {
    ...
    void withOneLeafNodeWithOneEmptyRecord_ShouldReturnIt() {
      ...
      // Act & Assert
      KeyValue<String, ByteArrayEncodedKey, String> firstItem = new KeyValue<>(createForTest(wormhole, ""), "foo");
    ...
    void withOneLeafNodeWithOneRecord_ShouldReturnIt() {
      ...
      // Act & Assert
      KeyValue<String, ByteArrayEncodedKey, String> firstItem = new KeyValue<>(createForTest(wormhole, "James"), "semaj");
    ...
    void withOneLeafNodeWithMaxRecords_ShouldReturnIt() {
      ...
      // Act & Assert
      KeyValue<String, ByteArrayEncodedKey, String> firstItem = new KeyValue<>(createForTest(wormhole, "James"), "semaj");
      KeyValue<String, ByteArrayEncodedKey, String> secondItem = new KeyValue<>(createForTest(wormhole, "Jason"), "nosaj");
      KeyValue<String, ByteArrayEncodedKey, String> thirdItem = new KeyValue<>(createForTest(wormhole, "John"), "nhoj");
      assertThat(wormhole.scanWithCount("I", 1)).containsExactly(firstItem);
    ...
    void withTwoLeafNodes_ShouldReturnIt() {
      ...
      // Act & Assert
      KeyValue<String, ByteArrayEncodedKey, String> firstItem = new KeyValue<>(createForTest(wormhole, "Jacob"), "bocaj");
      KeyValue<String, ByteArrayEncodedKey, String> secondItem = new KeyValue<>(createForTest(wormhole, "James"), "semaj");
      KeyValue<String, ByteArrayEncodedKey, String> thirdItem = new KeyValue<>(createForTest(wormhole, "Jason"), "nosaj");
      KeyValue<String, ByteArrayEncodedKey, String> fourthItem = new KeyValue<>(createForTest(wormhole, "John"), "nhoj");
      KeyValue<String, ByteArrayEncodedKey, String> fifthItem = new KeyValue<>(createForTest(wormhole, "Joseph"), "hpesoj");
      assertThat(wormhole.scanWithCount("I", 1)).containsExactly(firstItem);
      assertThat(wormhole.scanWithCount("I", 2)).containsExactly(firstItem, secondItem);
      assertThat(wormhole.scanWithCount("I", 3)).containsExactly(firstItem, secondItem, thirdItem);
    ...
    void withTwoLeafNodes_UsingSameCharForKey_ShouldReturnIt() {
      ...
      // Act & Assert
      KeyValue<String, ByteArrayEncodedKey, Integer> firstItem = new KeyValue<>(createForTest(wormhole, "a"), 1);
      KeyValue<String, ByteArrayEncodedKey, Integer> secondItem = new KeyValue<>(createForTest(wormhole,"aa"), 2);
      KeyValue<String, ByteArrayEncodedKey, Integer> thirdItem = new KeyValue<>(createForTest(wormhole,"aaa"), 3);
      KeyValue<String, ByteArrayEncodedKey, Integer> fourthItem = new KeyValue<>(createForTest(wormhole,"aaaa"), 4);
      KeyValue<String, ByteArrayEncodedKey, Integer> fifthItem = new KeyValue<>(createForTest(wormhole,"aaaaa"), 5);
